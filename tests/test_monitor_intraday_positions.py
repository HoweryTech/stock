...
class MonitorIntradayPositionsTest(unittest.TestCase):
    ...
    def test_reverse_t_candidate_near_intraday_high(self) -> None:
        ...
        self.assertEqual(plan["current_reference_zone"], [3.28, 3.3])
        self.assertLess(plan["current_reference_zone"][1], plan["sell_zone"][1])
        self.assertIn("锚定现价3.29", plan["current_reference_reason"])
    ...
    def test_blocked_reverse_t_still_exposes_fee_aware_reference_range(self) -> None:
        ...
        self.assertEqual(plan["current_reference_zone"], [13.63, 13.68])
