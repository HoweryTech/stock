...
def build_summary_args(args: argparse.Namespace) -> Namespace:
    return Namespace(
        ...
        holding_action_draft=args.holding_action_draft,
        portfolio_action_backtests=args.portfolio_action_backtests,
        realtime_decision_cards=args.realtime_decision_cards,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--realtime-decision-cards", default="data/metadata/realtime-decision-cards.json", help="Realtime decision cards JSON generated by run_intraday_decision_pipeline.py.")
