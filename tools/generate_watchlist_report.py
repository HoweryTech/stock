...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate a watchlist report from trend candidates.")
    parser.add_argument("--candidates", default="data/processed/trend_candidates.csv", help="Input candidate CSV.")
